...
public class MainActivity extends AbsActivity<ActivityMainBinding>
  ...
  @Bind(R.id.drawer_layout) DrawerLayout mDLayout;
  @Bind(R.id.nav_view) NavigationView mNv;
  ...
  @Override protected void init(Bundle savedInstanceState) {
    ...
    ActionBarDrawerToggle toggle =
        new ActionBarDrawerToggle(this, mDLayout, mToolbar, R.string.navigation_drawer_open,
