 ...
 */
public class MainFragment extends AbsFragment<FragmentTestBinding> implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.permission:
                PermissionManager.getInstance().requestPermission(MainFragment.this, new OnPermissionCallback() {
                    @Override
